...
import { SUPER_ADMIN_POSTS_PATH } from '../../../core/paths/paths';
...
@Controller(SUPER_ADMIN_POSTS_PATH)
export class SuperAdminPostsController {
  ...
  async createPost(@Body() body: CreatePostInputDto): Promise<PostViewDto> {
    ...
    const postId = await this.commandBus.execute<CreatePostCommand,
      string>(new CreatePostCommand(body));
  ...
  async updatePost(
    ...
    return this.commandBus.execute<UpdatePostCommand, void>(new UpdatePostCommand(id, body));
  }
  ...
  async deletePost(@Param('id') id: string): Promise<void> {
    ...
    return this.commandBus.execute<DeletePostCommand, void>(new DeletePostCommand(id));
  }
